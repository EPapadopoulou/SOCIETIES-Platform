...
public class Accordion extends JPanel implements ActionListener
{
    ...
    public void render()
    {
    	...
    	if (this.bars.size()==0){
            ...
            {
            	System.out.println("visible component not null");
                this.remove( this.visibleComponent );
                this.repaint();
            }else{
            	System.out.println("visible component is null");
            }
        ...
        System.out.println("totalbars size: "+totalBars);
        ...
        {
        	System.out.println("I have so many keys in my keyset: "+this.bars.keySet().size());
